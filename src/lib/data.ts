...
export const messages: Message[] = [
    { id: 'm1', patientId: '1', sender: 'Clinician', text: 'Hi Arjun, how are you feeling today?', timestamp: '9:00 AM'},
